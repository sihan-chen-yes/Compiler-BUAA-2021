...
public class BasicBlock {
    ...
    private HashSet<String> RDIn = new HashSet<>();
    private HashSet<String> RDOut = new HashSet<>();

    private HashSet<String> def = new HashSet<>();
    private HashSet<String> use = new HashSet<>();
    private HashSet<String> DUIn = new HashSet<>();
    private HashSet<String> DUOut = new HashSet<>();
    ...
    public DAGNode genCalNode(OpType opType,DAGNode left,DAGNode middle,DAGNode right) {
        DAGNode node = new DAGNode(opType,num);
    ...
    public DAGNode genOperandNode(String name) {
        DAGNode node = new DAGNode(name,num);
        record.put(name,num);
        dagNodes.put(num,node);
        num++;
        return node;
